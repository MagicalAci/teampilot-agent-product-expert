...
from spca.config import build_bootstrap_manifest  # noqa: E402
from spca.doctor import detect_mcp_status  # noqa: E402
...
class BootstrapContractsTest(unittest.TestCase):
    ...
    def test_doctor_command_supports_json_without_task_card(self):
        ...
        self.assertIn("system_packages", payload)
    ...
    def test_bootstrap_manifest_declares_managed_runtime_and_mcp_dependencies(self):
        manifest = build_bootstrap_manifest(home=Path("/tmp/spca-home"))

        self.assertIn(".cursor/skills-runtime/single-product-competitor-analysis", manifest["managed_runtime"]["root"])
