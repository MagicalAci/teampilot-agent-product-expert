...
这份协议定义 full 版 `research-toolkit` 在 `macOS` 上的首启协议、MCP 状态检查方式、以及平台级降级规则。
...
```bash
bash "~/.cursor/skills/research-toolkit/scripts/doctor-macos.sh"
...
6. 创建受管 venv：`~/.cursor/skills-runtime/research-toolkit/venv`
