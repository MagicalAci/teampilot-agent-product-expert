...
class ProductExpertAgentRepositoryTest(unittest.TestCase):
    ...
    def test_skill_directories_keep_key_assets(self):
        expected_paths = [
            ...
            "skills/ai-planning-orchestrator/scripts/run_eval.py",
            "skills/ai-planning-orchestrator/scripts/aggregate_eval_dataset.py",
            "skills/ai-planning-orchestrator/scripts/gen_eval_report.py",
            "skills/ai-planning-orchestrator/assets/eval-dataset-template.jsonl",
            "skills/ai-planning-orchestrator/assets/eval-report-template.md",
            "skills/ai-planning-orchestrator/references/prompt-strategy-first.md",
            "skills/ai-planning-orchestrator/references/ai-service-construction.md",
            "skills/ai-planning-orchestrator/references/eval-driven-development.md",
            "skills/ai-planning-orchestrator/tests/test_pipeline_smoke.py",
            "policies/llm-eval-methodology.md",
            "skills/product-demo-orchestrator/SKILL.md",
